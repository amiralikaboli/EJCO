...
int main() {
    ...
    for (int iter = 0; iter < 1 + 5; ++iter) {
        ...
        unordered_multimap<int, int> at_trie0(at_offsets.size());
                            ...
                            for (auto mc_it = mc_range.first; mc_it != mc_range.second; ++mc_it) {
                                ...
                                if (ct_trie0.contains(x3)) {
                                    ...
                                    if (cn_trie0.contains(x4)) {
                                        ...
                                        auto at_range = at_trie0.equal_range(x0);
                                        if (at_range.first != at_range.second) {
                                            mn_interm0_col2 = min(mn_interm0_col2, interm0_col2[interm0_off]);
                                            for (auto at_it = at_range.first; at_it != at_range.second; ++at_it) {
                                                auto at_off = at_it->second;
