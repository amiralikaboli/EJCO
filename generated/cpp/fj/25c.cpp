...
int main() {
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        cnt = 0;
        if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 0) {
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 1) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 0) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 1) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 0) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 1) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 0) {
            for (const auto &mi_off : mi_offsets) {
                auto x0 = mi_movie_id[mi_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 0) {
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0 && n_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_vtrie0.contains(x0)) {
                    auto &interm1_vtrie1 = interm1_vtrie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && t_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 1 && n_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_movie_id[ci_off];
                if (interm1_itrie0.contains(x0)) {
                    auto &interm1_itrie1 = interm1_itrie0.at(x0);
