...
int main() {
    ...
    for (int iter = 0; iter < 1 + 5; ++iter) {
        ...
        if (interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            if (iter == 0)
                cout << "{interm4: v, interm6: v, chn: v}" << endl;
        ...
        } else if (interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            if (iter == 0)
                cout << "{interm4: v, interm6: v, chn: i}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            if (iter == 0)
                cout << "{interm4: v, interm6: i, chn: v}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            if (iter == 0)
                cout << "{interm4: v, interm6: i, chn: i}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            if (iter == 0)
                cout << "{interm4: i, interm6: v, chn: v}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            if (iter == 0)
                cout << "{interm4: i, interm6: v, chn: i}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            if (iter == 0)
                cout << "{interm4: i, interm6: i, chn: v}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
            ...
            if (iter == 0)
                cout << "{interm4: i, interm6: i, chn: i}" << endl;
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
