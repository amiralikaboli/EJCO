...
int main() {
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                ...
                if (rt_trie0.contains(x0)) {
                    ...
                    if (interm4_vtrie0.contains(x1)) {
                        ...
                        if (interm6_vtrie0.contains(x2)) {
                            auto &interm6_vtrie1 = interm6_vtrie0.at(x2);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
                    ...
                    if (interm4_vtrie0.contains(x1)) {
                        auto &interm4_vtrie1 = interm4_vtrie0.at(x1);
                        auto x2 = ci_person_id[ci_off];
                        if (interm6_itrie0.contains(x2)) {
                            auto &interm6_itrie1 = interm6_itrie0.at(x2);
                            auto x3 = ci_person_role_id[ci_off];
                            if (chn_vtrie0.contains(x3)) {
                                auto &chn_vtrie1 = chn_vtrie0.at(x3);
                                for (const auto &chn_off : chn_vtrie1) {
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 0 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 0 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 0 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 0 && interm6_isunq == 1 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 0 && chn_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (interm1_isunq == 1 && interm2_isunq == 1 && interm3_isunq == 1 && interm4_isunq == 1 && interm6_isunq == 1 && chn_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
