...
int main() {
	...
	for (int z = 0; z < 1 + 5; ++z) {
		...
		int mn_interm3_col6 = numeric_limits<int>::max();
		...
		if (z == 0)
			cout << mn_n_name << " | " << mn_chn_name << " | " << mn_interm3_col0 << " | " << mn_interm3_col2 << " | " << mn_interm3_col3 << " | " << mn_interm3_col4 << " | " << mn_interm3_col5 << " | " << mn_interm3_col6 << " | " << mn_interm3_col7 << endl;
		cout << "*" << " " << flush;
	}
	cout << endl;
