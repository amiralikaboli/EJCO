															...
															for (const auto &[x7, mc_trie2]: mc_trie1) {
																if (ct_trie0.contains(x7)) {
																	...
																	if (mc_trie2.contains(x3)) {
																		...
																		for (const auto &[x9, mk_trie1]: mk_trie0) {
																			if (k_trie0.contains(x9)) {
																				auto &k_trie1 = k_trie0.at(x9);
																				if (mk_trie1.contains(x3)) {
																					auto &mk_trie2 = mk_trie1.at(x3);
																					for (const auto &[x11, mi_trie1]: mi_trie0) {
																						if (it1_trie0.contains(x11)) {
																							auto &it1_trie1 = it1_trie0.at(x11);
