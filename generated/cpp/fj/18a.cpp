...
int main() {
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        if (mi_idx_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0) {
        ...
        } else if (mi_idx_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
        ...
        } else if (mi_idx_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
        ...
        } else if (mi_idx_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_trie0.contains(x0)) {
                    auto &n_trie1 = n_trie0.at(x0);
