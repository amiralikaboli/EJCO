...
int main() {
    ...
    load_t("/Users/s2522996/Documents/free-join/queries/preprocessed/join-order-benchmark/data/6d/t.csv");
    load_k("/Users/s2522996/Documents/free-join/queries/preprocessed/join-order-benchmark/data/6d/k.csv");
    load_ci("/Users/s2522996/Documents/free-join/data/imdb_csv/cast_info.csv");
    load_n("/Users/s2522996/Documents/free-join/queries/preprocessed/join-order-benchmark/data/6d/n.csv");
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        if (k_isunq == 0 && t_isunq == 0 && n_isunq == 0 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 0 && n_isunq == 0 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 0 && n_isunq == 1 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
                    auto x1 = ci_movie_id[ci_off];
                    if (interm0_vtrie0.contains(x1)) {
                        auto &interm0_vtrie1 = interm0_vtrie0.at(x1);
                        auto &n_off = n_itrie1;
        ...
        } else if (k_isunq == 0 && t_isunq == 0 && n_isunq == 1 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 1 && n_isunq == 0 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 1 && n_isunq == 0 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 1 && n_isunq == 1 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
        ...
        } else if (k_isunq == 0 && t_isunq == 1 && n_isunq == 1 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 0 && n_isunq == 0 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 0 && n_isunq == 0 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 0 && n_isunq == 1 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 0 && n_isunq == 1 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 1 && n_isunq == 0 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 1 && n_isunq == 0 && interm0_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_vtrie0.contains(x0)) {
                    auto &n_vtrie1 = n_vtrie0.at(x0);
        ...
        } else if (k_isunq == 1 && t_isunq == 1 && n_isunq == 1 && interm0_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (n_itrie0.contains(x0)) {
                    auto &n_itrie1 = n_itrie0.at(x0);
