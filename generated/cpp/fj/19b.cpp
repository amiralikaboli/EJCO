...
int main() {
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        if (t_isunq == 0 && mc_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                ...
                if (rt_trie0.contains(x0)) {
                    ...
                    if (interm0_vtrie0.contains(x1)) {
                        ...
                        if (interm1_vtrie0.contains(x2)) {
                            auto &interm1_vtrie1 = interm1_vtrie0.at(x2);
        ...
        } else if (t_isunq == 0 && mc_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
                    ...
                    if (interm0_vtrie0.contains(x1)) {
                        auto &interm0_vtrie1 = interm0_vtrie0.at(x1);
                        auto x2 = ci_person_id[ci_off];
                        if (interm1_itrie0.contains(x2)) {
                            auto &interm1_itrie1 = interm1_itrie0.at(x2);
                            auto x3 = ci_person_role_id[ci_off];
                            if (chn_trie0.contains(x3)) {
                                auto &chn_trie1 = chn_trie0.at(x3);
        ...
        } else if (t_isunq == 0 && mc_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 0 && mc_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 0 && mc_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 0 && mc_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 0 && mc_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 0 && mc_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
        ...
        } else if (t_isunq == 1 && mc_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_role_id[ci_off];
                if (rt_trie0.contains(x0)) {
                    auto &rt_trie1 = rt_trie0.at(x0);
