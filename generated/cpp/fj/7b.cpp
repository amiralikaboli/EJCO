...
int main() {
    ...
    for (int z = 0; z < 1 + 5; ++z) {
        ...
        if (pi_isunq == 0 && ml_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0) {
        ...
        } else if (pi_isunq == 0 && ml_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 0 && ml_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
        ...
        } else if (pi_isunq == 0 && ml_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (pi_isunq == 0 && ml_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 0 && ml_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 0 && ml_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (pi_isunq == 0 && ml_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 0 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 0 && interm0_isunq == 1 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 1 && interm0_isunq == 0 && interm1_isunq == 1) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_vtrie0.contains(x0)) {
                    auto &interm0_vtrie1 = interm0_vtrie0.at(x0);
        ...
        } else if (pi_isunq == 1 && ml_isunq == 1 && interm0_isunq == 1 && interm1_isunq == 0) {
            for (const auto &ci_off : ci_offsets) {
                auto x0 = ci_person_id[ci_off];
                if (interm0_itrie0.contains(x0)) {
                    auto &interm0_itrie1 = interm0_itrie0.at(x0);
